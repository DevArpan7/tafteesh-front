              ...
              <div className="survivor_card_bar">
                <ul>
                  ...
                  <li>
                    ...
                    <h5>{survivorActionDetails && survivorActionDetails.loan && survivorActionDetails.loan.exist== true ?"Yes" : survivorActionDetails && survivorActionDetails.income && survivorActionDetails.income.exist== true ?"Yes" :survivorActionDetails && survivorActionDetails.grant && survivorActionDetails.grant.exist== true ?"Yes" : "No" }</h5>
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <h5>{survivorActionDetails && survivorActionDetails.rescue && survivorActionDetails.rescue.sinceMonth}</h5>
                  </li>
                  <li>
