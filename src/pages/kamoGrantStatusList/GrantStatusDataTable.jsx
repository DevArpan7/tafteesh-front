...
const GrantStatusDataTable = (props) => {
  const [customers1, setCustomers1] = useState([]);
  const [filters1, setFilters1] = useState(null);
  const { grantStatusList, onSelectRow ,isLoading,selectedProduct5} = props;
  ...
  const customerService =
    grantStatusList && grantStatusList.length > 0 && grantStatusList;
  ...
  const createdAtMarkBodyTemplate = (rowData) => {
    return (rowData.grantStatus_created_date);
  };
  ...
  return (
    <div className="dataTableFilter">
        ...
        <Column
            header="Created At"
            dataType="date"
            filterField="grantStatus_created_date"
            style={{ minWidth: "15rem" }}
...
export default GrantStatusDataTable;