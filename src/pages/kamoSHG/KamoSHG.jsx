...
const KamoSHG = (props) => {
  ...
  const onDeleteChangeFunc = () => {
    if (selectedData && !selectedData._id) {
      setShowAlert(true);
      setAlertMessage("Please select one SHG");
      setAlertFlag("alert");
    } else {
      setShowAlert(true);
      setAlertMessage("");
  ...
  const downloadPdf = () => {
    ...
    doc.setFontSize(20);
    doc.setTextColor(40);
    doc.text("SHG DETAILS", 22, 10);
    const survivorColumns = ["SHG NAME", "CREATED AT"];
    const name = "shg-list" + new Date().toISOString() + ".pdf";
    let goalsRows = [];
    shgList.data?.forEach((item) => {
