...
const TypeofAgencyDataTable = (props) => {
  const [customers1, setCustomers1] = useState([]);
  const [filters1, setFilters1] = useState(null);
  const { agencyTypeList, onSelectRow ,isLoading,selectedProduct5} = props;
  ...
  const customerService =
    agencyTypeList && agencyTypeList.length > 0 && agencyTypeList;
  ...
  const createdAtMarkBodyTemplate = (rowData) => {
    return (rowData.type_of_agency_created_date);
  };
  ...
  return (
    <div className="dataTableFilter">
        ...
        <Column
            header="Created At"
            dataType="date"
            filterField="type_of_agency_created_date"
            style={{ minWidth: "15rem" }}
...
export default TypeofAgencyDataTable;
