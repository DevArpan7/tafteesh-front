...
import { getPcResultList, deleteCollective } from "../../redux/action";
...
import PcResultDataTable from "./PcResultDataTable";
import { jsPDF } from "jspdf";
import "jspdf-autotable";
const KamoPcResult = (props) => {
  ...
  const pcResultList = useSelector((state) => state.pcResultList);
  const [addCollectiveData, setAddCollectiveData] = useState({});
  const [updateMessage, setUpdateMessage] = useState("");
  const api = "https://tafteesh-staging-node.herokuapp.com/api/pc-result";
  ...
  const downloadPdf = () => {
    ...
    doc.setFontSize(20);
    doc.setTextColor(40);
    doc.text("PC RESULT DETAILS", 22, 10);
    const survivorColumns = ["PC RESULT", "CREATED AT"];
    const name = "pc-result-list" + new Date().toISOString() + ".pdf";
    let goalsRows = [];
        ...
        <div className="bodyright">
          <div className="row justify-content-between">
            <div className="col-auto">
              <h2 className="page_title">PC Results List</h2>
            </div>
          </div>
