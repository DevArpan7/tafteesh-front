...
const PcResultDataTable = (props) => {
  ...
  const createdAtMarkBodyTemplate = (rowData) => {
    return (rowData.pcResult_created_date);
  };
  ...
  return (
    <div className="dataTableFilter">
        ...
        <Column
            header="Created At"
            dataType="date"
            filterField="pcResult_created_date"
            style={{ minWidth: "15rem" }}
...
export default PcResultDataTable;