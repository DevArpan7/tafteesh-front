...
const KamoGrantNameDataTable = (props) => {
  const [customers1, setCustomers1] = useState([]);
  const [filters1, setFilters1] = useState(null);
  const { grantList, onSelectRow ,isLoading,selectedProduct5} = props;
  ...
  const customerService =
    grantList && grantList.length > 0 && grantList;
...
export default KamoGrantNameDataTable;
