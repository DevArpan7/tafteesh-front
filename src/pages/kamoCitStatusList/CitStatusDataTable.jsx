...
const CitStatusDataTable = (props) => {
  const [customers1, setCustomers1] = useState([]);
  const [filters1, setFilters1] = useState(null);
  const { citStatusList, onSelectRow ,isLoading,selectedProduct5} = props;
  ...
  const createdAtMarkBodyTemplate = (rowData) => {
    return (rowData.citStatus_created_date);
  };
  ...
  return (
    <div className="dataTableFilter">
        ...
        <Column
            header="Created At"
            dataType="date"
            filterField="citStatus_created_date"
            style={{ minWidth: "15rem" }}
...
export default CitStatusDataTable;