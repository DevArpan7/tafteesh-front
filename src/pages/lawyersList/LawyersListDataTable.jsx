...
const LawyersListDataTable = (props) => {
  ...
  const { lawyersList, onSelectRow,isLoading ,selectedProduct5} = props;
  ...
  const categoryBodyTemplate = (rowData) => {
    ...
    return (
      ...
      <span className={`customer-badge status-${rowData.category_name}`}>
  ...
  const blockIdBodyTemplate = (rowData) => {
    ...
    return (
      <>  
      <span className={`customer-badge status-${rowData.court_name}`}>
        {rowData.court_name}
      </span>
  ...
  const locationBodyTemplate = (rowData) => {
    ...
    return (
      <span className={`customer-badge status-${rowData.location_name && rowData.location_name }`}>
