...
const AuthorityListDataTable = (props) => {
  ...
  const { authorityList, onSelectRow ,isLoading,selectedProduct5} = props;
  ...
  const authprityBodyTemplate =(rowData)=>{
    return (
      <span className={`customer-badge status-${rowData.authority_type_name && rowData.authority_type_name}`}>
        {rowData.authority_type_name && rowData.authority_type_name}
      </span>
    );
  }
  ...
  const createdAtMarkBodyTemplate = (rowData) => {
    return (rowData.authority_created_date);
  };
    ...
    <div className="dataTableFilter">
        ...
        />
         <Column
            ...
            // dataType="date"
            filterField="authority_type_name"
            style={{ minWidth: "15rem" }}
            body={authprityBodyTemplate}
            // filter
            filterElement={balanceFilterTemplate}
        />
        ...
        <Column
            header="Created At"
            dataType="date"
            filterField="authority_created_date"
            style={{ minWidth: "15rem" }}
