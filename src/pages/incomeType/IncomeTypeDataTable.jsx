...
const IncomeTypeDataTable = (props) => {
  const [customers1, setCustomers1] = useState([]);
  const [filters1, setFilters1] = useState(null);
  const { incomeTypeList, onSelectRow ,isLoading,selectedProduct5} = props;
  ...
  const customerService =
    incomeTypeList && incomeTypeList.length > 0 && incomeTypeList;
  ...
  const createdAtMarkBodyTemplate = (rowData) => {
    return (rowData.earning_type_created_date);
  };
  ...
  return (
    <div className="dataTableFilter">
        ...
        <Column
            header="Created At"
            dataType="date"
            filterField="earning_type_created_date"
            style={{ minWidth: "15rem" }}
...
export default IncomeTypeDataTable;
