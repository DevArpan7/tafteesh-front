...
const LawyerCategoryDataTable = (props) => {
  ...
  const { lawyersCategoryList, onSelectRow ,isLoading,selectedProduct5} = props;
  ...
  const createdAtMarkBodyTemplate = (rowData) => {
    return (rowData.lawyer_category_created_date);
  };
  ...
  return (
    <div className="dataTableFilter">
        ...
        <Column
            header="Created At"
            dataType="date"
            filterField="lawyer_category_created_date"
            style={{ minWidth: "15rem" }}
