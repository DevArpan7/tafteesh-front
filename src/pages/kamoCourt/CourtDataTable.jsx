...
const CourtDataTable = (props) => {
  const [customers1, setCustomers1] = useState([]);
  const [filters1, setFilters1] = useState(null);
  const { courtList, onSelectRow ,isLoading,selectedProduct5} = props;
  ...
  const customerService =
    courtList && courtList.length > 0 && courtList;
  ...
  const createdAtMarkBodyTemplate = (rowData) => {
    return (rowData.court_created_date);
  };
  ...
  return (
    <div className="dataTableFilter">
        ...
        <Column
            header="Created At"
            dataType="date"
            filterField="court_created_date"
            style={{ minWidth: "15rem" }}
