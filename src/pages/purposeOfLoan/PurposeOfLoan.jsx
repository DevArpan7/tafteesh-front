...
import { getLoanPurposeList } from "../../redux/action";
...
import PurposeOfLoanDataTable from "./PurposeOfLoanDataTable";

const PurposeOfLoan = (props) => {
  ...
  const api = "https://tafteesh-staging-node.herokuapp.com/api/loan-purpose";
  ...
  // //console.log(loanPurposeList,'ssssssssssssssssss')
  //get all act list

  // const fetchAllloanPurposeList = () => {
  ...
  //             }
  //             // //console.log(response,'loanPurposeList response')
  //         })
  ...
  const exportToCsv = (e) => {
    ...
    let headers = ["Id,Loan Purpose,CreatedAt"];

    // Convert users data to a csv
    let usersCsv = loanPurposeList.reduce((acc, user) => {
  ...
  // //console.log(loanPurposeList,'loanPurposeList data')
  ...
  const downloadPdf = () => {
    ...
    doc.setFontSize(20);
    doc.setTextColor(40);
    doc.text("LOAN PURPOSE DETAILS", 22, 10);
    const survivorColumns = ["LOAN PURPOSE", "CREATED AT"];
    const name = "purpose-of-loan-list" + new Date().toISOString() + ".pdf";
    let goalsRows = [];
    loanPurposeList?.forEach((item) => {
    ...
    <>
      ...
      <main className="main_body">
        ...
        <div className="bodyright">
          <div className="row justify-content-between">
            <div className="col-auto">
              <h2 className="page_title">Purpose of Loan List</h2>
            </div>
          </div>
          <div className="white_box_shadow_20 survivors_table_wrap vieweditdeleteMargin40 position-relative">
            ...
            <PurposeOfLoanDataTable
              loanPurposeList={loanPurposeList && loanPurposeList.length > 0 && loanPurposeList}
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title id="contained-modal-title-vcenter">
              { addShgData && addShgData._id ? "Update Loan Purpose": "Add Loan Purpose"}
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <div className="site_form_wraper">
