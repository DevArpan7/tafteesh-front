...
const PurposeOfLoanDataTable = (props) => {
  const [customers1, setCustomers1] = useState([]);
  const [filters1, setFilters1] = useState(null);
  const { loanPurposeList, onSelectRow ,isLoading,selectedProduct5} = props;
  ...
  const customerService =
    loanPurposeList && loanPurposeList.length > 0 && loanPurposeList;
  ...
  const createdAtMarkBodyTemplate = (rowData) => {
    return (rowData.purpose_of_loan_created_date);
  };
  ...
  return (
    <div className="dataTableFilter">
        ...
        <Column
            header="Created At"
            dataType="date"
            filterField="purpose_of_loan_created_date"
            style={{ minWidth: "15rem" }}
...
export default PurposeOfLoanDataTable;
