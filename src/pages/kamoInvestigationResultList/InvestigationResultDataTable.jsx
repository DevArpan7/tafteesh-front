...
const InvestigationResultDataTable = (props) => {
  const [customers1, setCustomers1] = useState([]);
  const [filters1, setFilters1] = useState(null);
  const { investResultList, onSelectRow ,isLoading,selectedProduct5} = props;
  ...
  const customerService =
    investResultList && investResultList.length > 0 && investResultList;
  ...
  const createdAtMarkBodyTemplate = (rowData) => {
    return (rowData.invResult_created_date);
  };
  ...
  return (
    <div className="dataTableFilter">
        ...
        <Column
            header="Created At"
            dataType="date"
            filterField="invResult_created_date"
            style={{ minWidth: "15rem" }}
...
export default InvestigationResultDataTable;