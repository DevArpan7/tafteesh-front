...
const VcEscResultDataTable = (props) => {
  const [customers1, setCustomers1] = useState([]);
  const [filters1, setFilters1] = useState(null);
  const { vcResultList, onSelectRow ,isLoading,selectedProduct5} = props;
  ...
  const createdAtMarkBodyTemplate = (rowData) => {
    return (rowData.vcEscalation_created_date);
  };
  ...
  return (
    <div className="dataTableFilter">
        ...
        <Column
            header="Created At"
            dataType="date"
            filterField="vcEscalation_created_date"
            style={{ minWidth: "15rem" }}
...
export default VcEscResultDataTable;