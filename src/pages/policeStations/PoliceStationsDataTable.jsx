...
const PoliceStationsDataTable = (props) => {
  ...
  const { policeStationList, onSelectRow,isLoading,selectedProduct5 } = props;
  ...
  const distBodyTemplate = (rowData) => {
    ...
    return (
      <span className={`customer-badge status-${rowData.district_name && rowData.district_name}`}>
        {rowData.district_name && rowData.district_name}
      </span>
    );
  };
  const blockBodyTemplate = (rowData) => {
    ...
    return (
      <span className={`customer-badge status-${rowData.block_name && rowData.block_name}`}>
        {rowData.block_name && rowData.block_name}
      </span>
    );
  };
  const createdAtMarkBodyTemplate = (rowData) => {
    return (rowData.police_station_created_date);
  };
  ...
  return (
    <div className="dataTableFilter">
        ...
        <Column
            header="Created At"
            dataType="date"
            filterField="police_station_created_date"
            style={{ minWidth: "15rem" }}
