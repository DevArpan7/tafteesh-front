...
const PcEscalationResultDataTable = (props) => {
  console.log("props", props);
  const [customers1, setCustomers1] = useState([]);
  const [filters1, setFilters1] = useState(null);
  const { pcResultList, onSelectRow ,isLoading,selectedProduct5} = props;
  ...
  useEffect(() => {
    ...
    let arr = [];
    pcResultList &&
      pcResultList.length > 0 &&
      pcResultList.map((item) => {
  ...
  const createdAtMarkBodyTemplate = (rowData) => {
    return (rowData.pcEscalation_created_date);
  };
  ...
  return (
    <div className="dataTableFilter">
        ...
        <Column
            header="Created At"
            dataType="date"
            filterField="pcEscalation_created_date"
            style={{ minWidth: "15rem" }}
...
export default PcEscalationResultDataTable;