...
const ActListDataTable = (props) => {
  ...
  const nameBodyTemplate = (rowData) => {
    ...
    return (
      <span className={`customer-badge status-${rowData.reporting_to_name && rowData.reporting_to_name}`}>
        {rowData.reporting_to_name && rowData.reporting_to_name}
      </span>
    );
  };
  ...
  const createdAtMarkBodyTemplate = (rowData) => {
    return (rowData.role_created_date);
  };
