...
const SurvivorStatusDataTable = (props) => {
  const [customers1, setCustomers1] = useState([]);
  const [filters1, setFilters1] = useState(null);
  const { survivorStatusList, onSelectRow ,isLoading,selectedProduct5} = props;
  ...
  const customerService =
    survivorStatusList && survivorStatusList.length > 0 && survivorStatusList;
  ...
  const createdAtMarkBodyTemplate = (rowData) => {
    return (rowData.survivorStatus_created_date);
  };
  ...
  return (
    <div className="dataTableFilter">
        ...
        <Column
            header="Created At"
            dataType="date"
            filterField="survivorStatus_created_date"
            style={{ minWidth: "15rem" }}
...
export default SurvivorStatusDataTable;