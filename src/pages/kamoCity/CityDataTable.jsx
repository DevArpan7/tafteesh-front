...
const CityDataTable = (props) => {
  const [customers1, setCustomers1] = useState([]);
  const [filters1, setFilters1] = useState(null);
  const { allCityList, onSelectRow ,isLoading,selectedProduct5} = props;
  ...
  const customerService =
    allCityList && allCityList.length > 0 && allCityList;
  ...
  const createdAtMarkBodyTemplate = (rowData) => {
    return (rowData.city_created_date);
  };
