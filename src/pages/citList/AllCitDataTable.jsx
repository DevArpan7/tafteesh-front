...
const AllCitDataTable = (props) => {
  ...
  const { allCitList, onSelectRow,isLoading,handleChange ,selectedProduct5} = props;
  ...
  const nameBodyTemplate = (rowData) => {
    ...
    return (
      <span className={`customer-badge status-${rowData.custom_survivor_name && rowData.custom_survivor_name}`}>
        {rowData.custom_survivor_name && rowData.custom_survivor_name}
      </span>
    );
  };
  ...
  const statusMarkBodyTemplate = rowData => {
    ...
    return (
      <span className={`customer-badge status-${rowData.approval_data}`}>
  ...
  const dateBodyTemplate = (rowData) => {
    return (rowData.cit_assessment_date && rowData.cit_assessment_date);
  };
  ...
  return (
    <div className="dataTableFilter">
        ...
        <Column
            ...
            // dataType="date"
            filterField="custom_survivor_name"
