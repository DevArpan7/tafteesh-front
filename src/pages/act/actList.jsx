...
const ActList = (props) => {
  ...
  const addShgFunc = (e) => {
    ...
    if (addShgData && !addShgData.name) {
      ...
      setFieldData({
        field: "name",
        message: "Please enter valid Act",
      });
    }
      else {
      setFieldData({ field: "", message: "" });
  ...
  const [sampleArr, setSampleArr] = useState([{ Act: "ITPC" }]);
  ...
  const downloadPdf = () => {
    ...
    const survivorColumns = ["ACT", "CREATED AT"];
