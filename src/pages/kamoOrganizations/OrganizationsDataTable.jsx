...
const OrganizationsDataTable = (props) => {
  ...
  const { organizationList, onSelectRow,isLoading,selectedProduct5 } = props;
  ...
  const cityBodyTemplate = (rowData) => {    
    return (
      <span className={`customer-badge status-${rowData.org_city_name && rowData.org_city_name}`}>
        {rowData.org_city_name && rowData.org_city_name}
      </span>
    );
  };
  ...
  const stateBodyTemplate = (rowData) => {    
    return (
      <span className={`customer-badge status-${rowData && rowData.org_state_name && rowData.org_state_name}`}>
        {rowData && rowData.org_state_name && rowData.org_state_name}
      </span>
    );
  };
