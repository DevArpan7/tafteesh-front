...
const CitDimensionDataTable = (props) => {
  ...
  const { citDimensionList, onSelectRow ,isLoading,selectedProduct5} = props;
  ...
  const versionBodyTemplate = (rowData) => {
    ...
    return (
      <span className={`customer-badge status-${rowData.citVersionName && rowData.citVersionName}`}>
        {rowData.citVersionName && rowData.citVersionName}
      </span>
    );
  };
