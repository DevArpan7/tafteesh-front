...
const DistrictDataTable = (props) => {
  ...
  const { masterDistrictList, onSelectRow,isLoading,selectedProduct5 } = props;
  ...
  const createdAtMarkBodyTemplate = (rowData) => {
    return (rowData.district_created_date);
  };
  ...
  return (
    <div className="dataTableFilter">
        ...
        <Column
            header="Created At"
            dataType="date"
            filterField="district_created_date"
            style={{ minWidth: "15rem" }}
