...
const DiaryStatusDataTable = (props) => {
  const [customers1, setCustomers1] = useState([]);
  const [filters1, setFilters1] = useState(null);
  const { diaryStatusList, onSelectRow ,isLoading,selectedProduct5} = props;
  ...
  useEffect(() => {
    ...
    let arr = [];
    diaryStatusList &&
      diaryStatusList.length > 0 &&
      diaryStatusList.map((item) => {
  ...
  const createdAtMarkBodyTemplate = (rowData) => {
    return (rowData.diaryStatus_created_date);
  };
  ...
  return (
    <div className="dataTableFilter">
        ...
        <Column
            header="Created At"
            dataType="date"
            filterField="diaryStatus_created_date"
            style={{ minWidth: "15rem" }}
...
export default DiaryStatusDataTable;