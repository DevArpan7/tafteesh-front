...
const ActListDataTable = (props) => {
  ...
  const nameBodyTemplate = (rowData) => {
    ...
    return (
      <span className={`customer-badge status-${rowData.act_name && rowData.act_name}`}>
        {rowData.act_name && rowData.act_name}
      </span>
    );
  };
  ...
  const createdAtMarkBodyTemplate = (rowData) => {
    return (rowData.section_created_at);
  };
  ...
  return (
    <div className="dataTableFilter">
        ...
        <Column
            header="Created At"
            dataType="date"
            filterField="section_created_at"
            style={{ minWidth: "15rem" }}
