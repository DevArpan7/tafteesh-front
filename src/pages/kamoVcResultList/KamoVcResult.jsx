...
import { getVcResultList, deleteCollective } from "../../redux/action";
...
import VcResultDataTable from "./VcResultDataTable";
import { jsPDF } from "jspdf";
import "jspdf-autotable";
const KamoVcResult = (props) => {
  ...
  const api = "https://tafteesh-staging-node.herokuapp.com/api/vc-result";
  ...
  const downloadPdf = () => {
    ...
    doc.setFontSize(20);
    doc.setTextColor(40);
    doc.text("VC RESULT DETAILS", 22, 10);
    const survivorColumns = ["VC RESULT", "CREATED AT"];
        ...
        <div className="bodyright">
          <div className="row justify-content-between">
            <div className="col-auto">
              <h2 className="page_title">VC Results List</h2>
            </div>
          </div>
