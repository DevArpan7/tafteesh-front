...
const VcResultDataTable = (props) => {
  ...
  const createdAtMarkBodyTemplate = (rowData) => {
    return (rowData.vcResult_created_date);
  };
  ...
  return (
    <div className="dataTableFilter">
        ...
        <Column
            header="Created At"
            dataType="date"
            filterField="vcResult_created_date"
            style={{ minWidth: "15rem" }}
...
export default VcResultDataTable;