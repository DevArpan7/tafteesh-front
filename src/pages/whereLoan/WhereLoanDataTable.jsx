...
const WhereLoanDataTable = (props) => {
  const [customers1, setCustomers1] = useState([]);
  const [filters1, setFilters1] = useState(null);
  const { whereList, onSelectRow ,isLoading,selectedProduct5} = props;
  ...
  const customerService =
    whereList && whereList.length > 0 && whereList;
  ...
  const createdAtMarkBodyTemplate = (rowData) => {
    return (rowData.loan_where_created_date);
  };
  ...
  return (
    <div className="dataTableFilter">
        ...
        <Column
            header="Created At"
            dataType="date"
            filterField="loan_where_created_date"
            style={{ minWidth: "15rem" }}
...
export default WhereLoanDataTable;
