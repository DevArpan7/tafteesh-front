                ...
                <div className="white_box_shadow_20 single_profile_box mb30">
                    <div className="single_profile_box_top">
                        <div className="single_profile_box_top_left">
                            <img src={traffickerData && traffickerData.image
                        ? traffickerData.image[traffickerData.image.length-1]
                        : istockphoto
                        } alt="" />
                        </div>
                    ...
                    <div className="white_box_shadow">
                        <div className="survivor_card_bar">
                            <ul>
                                ...
                                <li>
                                    <h6 className="mb-2">Residential address</h6>
                                    <h5>{traffickerData && traffickerData.residential_address && traffickerData.residential_address}</h5>
                                </li>
