...
const InvestigationStatusDataTable = (props) => {
  const [customers1, setCustomers1] = useState([]);
  const [filters1, setFilters1] = useState(null);
  const { investigationStatusList, onSelectRow ,isLoading,selectedProduct5} = props;
  ...
  useEffect(() => {
    ...
    investigationStatusList &&
      ...
      investigationStatusList.map((item) => {
  ...
  const customerService =
    investigationStatusList && investigationStatusList.length > 0 && investigationStatusList;
  ...
  const createdAtMarkBodyTemplate = (rowData) => {
    return (rowData.invStatus_created_date);
  };
  ...
  return (
    <div className="dataTableFilter">
        ...
        <Column
            header="Created At"
            dataType="date"
            filterField="invStatus_created_date"
            style={{ minWidth: "15rem" }}
...
export default InvestigationStatusDataTable;