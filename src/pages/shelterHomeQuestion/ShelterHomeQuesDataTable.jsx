...
const ShelterHomeQuesDataTable = (props) => {
  ...
  const nameBodyTemplate = (rowData) => {
    ...
    return (
      <span className={`customer-badge status-${rowData.question}`}>
        {rowData.question}
      </span>
    );
  };
...
export default ShelterHomeQuesDataTable;
