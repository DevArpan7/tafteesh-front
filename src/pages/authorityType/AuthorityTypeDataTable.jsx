...
const AuthorityTypeDataTable = (props) => {
  ...
  const { authorityTypeList, onSelectRow,isLoading,selectedProduct5 } = props;
  ...
  const createdAtMarkBodyTemplate = (rowData) => {
    return (rowData.authority_type_created_date);
  };
  ...
  return (
    <div className="dataTableFilter">
        ...
        <Column
            header="Created At"
            dataType="date"
            filterField="authority_type_created_date"
            style={{ minWidth: "15rem" }}
