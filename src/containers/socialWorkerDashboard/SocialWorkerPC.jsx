            ...
            <div className="table-responsive">
              <table className="table table-borderless mb-0">
                ...
                <tbody>
                  ...
                  ) : showPcArray && showPcArray.length > 0 ? (
                    showPcArray.map((data) => {
                      return (
                        <tr>
                          <td>
                            {data.survivor &&
          ...
          <TabPanel index={0} value={0}>
            <div className="white_box_shadow_20 vc_summary_tab_text">
              <table className="table table-borderless mb-0">
                ...
                {
                    pcSaCounts && Object.keys(pcSaCounts).map(e => {
                      return (
                        <tr>
                          <td>{e.toUpperCase()}</td>
                          <td>{pcSaCounts[e]}</td>
                  ...
                  {/* <tr>
                    <td>PC order received</td>
                    <td>{countData && countData.totalVcSaApplied}</td>
                  </tr> */}
                  {/* <tr>
                    <td>PC lowest awarded amount</td>
                    <td>18,00,00</td>
                  </tr> */}
                  {/* <tr>
                    <td>PC highest awarded amount</td>
                    <td>3,000,00</td>
                  </tr>
                  <tr>
                    <td>PC average awarded amount</td>
                    <td>18,00,00</td>
                  </tr> */}
          ...
          <TabPanel index={1} value={1}>
            <div className="white_box_shadow_20 vc_summary_tab_text">
              <table className="table table-borderless mb-0">
                <tbody>
                {
                    pcDaCounts && Object.keys(pcDaCounts).map(e => {
                      return (
                        <tr>
                          <td>{e.toUpperCase()}</td>
                          <td>{pcDaCounts[e]}</td>
