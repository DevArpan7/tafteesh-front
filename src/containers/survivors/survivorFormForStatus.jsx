...
const survivorFormForStatus = (props) => {
  ...
  useEffect(() => {
    ...
    setPictureArr(prev=> [...prev, image]);
    }
  }, [pictureData && pictureData.filePath]);

  //console.log(pictureArr,"picturArr")
  ...
  useEffect(() => {
    ...
    } else if (survivorData && survivorData.surv_status) {
      setCustomError({
        name: "surv_status",
        message: "",
      });
  ...
  const addSurvivorFunc = (e) => {
    ...
    if (survivorData && !survivorData.survivor_name) {
      ...
      format.test(survivorData.village_name)
    ) {
      setCustomError({
        name: "village_name",
      ...
      setCustomError({ name: "pincode", message: "Pin no. is invalied" });
      // window.scrollTo(5, el.offsetTop);
    } else {
      setCustomError({ name: "", message: "" });
      const tempData = {
            ...
            <Row>
              ...
              <Form.Group className="form-group" as={Col} md="6">
                ...
                <Form.Select
                  ...
                  value={
                    survivorData &&
                    survivorData.surv_status &&
                    survivorData.surv_status._id
                  }
                  aria-label="Default select example"
                >
                  <option hidden="true" value={""}>
                  ...
                  {survivorStatusList && survivorStatusList.length > 0 && survivorStatusList.map((item)=>{
                    return(
              ...
              >
                ...
                <div className="profileUpload fileUpload">
                  ...
                  />
                  {survivorData && survivorData.picture && survivorData.picture.length > 0 && 
...
export default survivorFormForStatus;
