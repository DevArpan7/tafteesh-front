...
const ChargesheetDataTable = (props) => {
  ...
  const { chargeSheetList, onSelectRow,isLoading,selectedProduct5 } = props;
  ...
  const chargeSheetDateBodyTemplate = (rowData) => {
    return (rowData.chargesheet_date);
  ...
  const chargeSheetNoBodyTemplate = (rowData) => {
    ...
    return (
      <span className={`customer-badge status-${rowData.chargesheet_no }`}>
        {rowData.chargesheet_no }
      </span>
    );
  };
  ...
  return (
    <div className="dataTableFilter">
        ...
        <Column
            ...
            // dataType="date"
            filterField="chargesheet_no"
            style={{ minWidth: "12rem" }}
            body={chargeSheetNoBodyTemplate}
            filter
            filterPlaceholder="Search By Charge Sheet No"
          />
        <Column
            header="Charge sheet date"
            dataType="date"
            filterField="chargesheet_date "
