...
const InvestigationDataTable = (props) => {
  ...
  const { investigationList,onSelectRow,isLoading,selectedProduct5 } = props;
  ...
  const survivorNameBodyTemplate = (rowData) => {
    ...
    return (
      <React.Fragment>
        ...
        /> */}
        <span className="image-text">{rowData.agency_type  && rowData.agency_type }</span>
      </React.Fragment>
    );
  };
  ...
  const dateOfTraffickingBodyTemplate = (rowData) => {
    ...
    return (
      <span className={`customer-badge status-${rowData.agency_name  && rowData.agency_name }`}>
        {rowData.agency_name  && rowData.agency_name }
      </span>
    );
  };
  ...
  const phoneBodyTemplate = (rowData) => {
    return (
      <span className={`customer-badge status-${ rowData.status_of_investigation && rowData.status_of_investigation}`}>
        {rowData.status_of_investigation && rowData.status_of_investigation }
      </span>
    );
  };
    ...
    <div className="dataTableFilter">
        ...
        >
          ...
          <Column
            ...
            filter
            filterPlaceholder="Search By Agency Name"
          />
          <Column
            ...
            filter
            filterPlaceholder="Search By Rank Of Officer"
          />
          <Column
