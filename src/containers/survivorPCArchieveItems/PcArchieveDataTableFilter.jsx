...
//console.log(survivorName,'nameeeeeeee')
  useEffect(() => {
  ...
  const pcsurvBody = (rowData) => {
    return (rowData.pc_survivor_name);
  };
  ...
  const dgenderBodyTemplate = (rowData) => {
    return (
      <span className={`customer-badge status-${rowData.pc_court_name && rowData.pc_court_name}`}>
        {rowData.pc_court_name && rowData.pc_court_name }
      </span>
    );
  };
  ...
  const phoneBodyTemplate = (rowData) => {
    return (
      <span className={`customer-badge status-${rowData.pc_current_status && rowData.pc_current_status.toUpperCase()}`}>
        {rowData.pc_current_status && rowData.pc_current_status.toUpperCase()}
      </span>
    );
  };
