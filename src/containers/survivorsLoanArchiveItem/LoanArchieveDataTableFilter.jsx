...
const LoanDataTable = (props) => {
  ...
  const received_onBodyTemplate = (rowData) => {
    return (rowData.loan_received_on);
  ...
  const loan_purposeBodyTemplate = (rowData) => {
    return (
  ...
  const loan_WhereBodyTemplate = (rowData) => {
    return (
