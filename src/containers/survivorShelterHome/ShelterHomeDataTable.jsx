...
const ShelterHomeDataTable = (props) => {
  ...
  const fromDateBodyTemplate = (rowData) => {
    return (rowData.shelter_from_date && rowData.shelter_from_date);
  };

  const todateBodyTemplate = (rowData) => {
    return (rowData.shelter_to_date  && rowData.shelter_to_date );
  };
    ...
    <div className="dataTableFilter">
        ...
        >
          ...
          <Column
            ...
            filter
            filterPlaceholder="Search by home"
          />
          <Column
            header="From"
            dataType="date"
            filterField="shelter_from_date"
            style={{ minWidth: "10rem" }}
