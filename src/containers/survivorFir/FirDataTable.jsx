...
const FirDataTable = (props) => {
  ...
  const { firList, onSelectRow,isLoading ,selectedProduct5} = props;
  ...
  const firDateBodyTemplate = (rowData) => {
    return formatDate(rowData.fir_date && rowData.fir_date);
  ...
  const policeStation_nameBodyTemplate = (rowData) => {
  ...
  const firNumberBodyTemplate = (rowData) => {
    ...
    return (
      <span className={`customer-badge status-${rowData.fir_number && rowData.fir_number}`}>
        {rowData.fir_number && rowData.fir_number}
      </span>
    );
  };
    ...
    <div className="dataTableFilter">
        ...
        >
          ...
          />
            ...
            style={{ minWidth: "12rem" }}
            body={policeStation_nameBodyTemplate}
            filter
            filterPlaceholder="Search By Police Station"
          ...
          <Column
            ...
            filterPlaceholder="Search By FIR Number"
            filter
            //filterElement={balanceFilterTemplate}
          />
        ...
        <Column
            ...
            // filter
            filterPlaceholder="Search By FIR Date"
