...
const DocDataTableFilter = (props) => {
  ...
  const { survivorDetails,survivalDocList,onSelectRow,gotoReasonModal ,selectedProduct5,isLoading} = props;
  ...
  const survivorIdBodyTemplate = (rowData) => {
    return (
      <React.Fragment>
        ...
        <span className="image-text">{rowData.document_type_name &&rowData.document_type_name}</span>
      </React.Fragment>
        // <span className={`customer-badge status-${rowData &&rowData.document_type_name &&rowData.document_type_name.name}`}>
        //   {rowData &&rowData.document_type_name &&rowData.document_type_name.name}
        // </span>
    );
  };
  ...
  const survivorNameBodyTemplate = (rowData) => {
    ...
    return (
      <React.Fragment>
        ...
        {/* {rowData.file &&
          rowData.file && rowData.custom_file_name} */}
  ...
  return (
    <div className="dataTableFilter">
        ...
        >
          ...
          {/* <Column
            header="Type"
            filterField="document_type_name"
        ...
        <Column
            ...
            body={survivorIdBodyTemplate}
            filter
            filterPlaceholder="Search by Document Type"
          />

          <Column
            header="Document"
            filterField="custom_file_name"
          ...
          <Column
            ...
            filter
            filterPlaceholder="Search by Availability"
          />
          <Column
            header="Updated At"
