...
const GrantDataTable = (props) => {
  ...
  const fromDateBodyTemplate = (rowData) => {
    return (rowData.applied_date && rowData.applied_date);
  };

  const todateBodyTemplate = (rowData) => {
    return rowData.received_amount_so_far && numberFormat(rowData.received_amount_so_far);
  };
    ...
    <div className="dataTableFilter">
        ...
        >
          ...
          <Column
            ...
            filter
            filterPlaceholder="Search by application number"
          />
          ...
          <Column
            ...
            filter
            filterPlaceholder="Search by installment"
          />
