...
const ChargesheetDataTable = (props) => {
  ...
  const chargeSheetDateBodyTemplate = (rowData) => {
    return (rowData.charge_sheet_date);
  ...
  const chargeSheetNoBodyTemplate = (rowData) => {
    ...
    return (
      <span className={`customer-badge status-${rowData.charge_sheet_number && rowData.charge_sheet_number}`}>
        {rowData.charge_sheet_number && rowData.charge_sheet_number}
      </span>
    );
  };
  ...
  return (
    <div className="dataTableFilter">
        ...
        <Column
            ...
            // dataType="date"
            filterField="charge_sheet_number"
            style={{ minWidth: "12rem" }}
