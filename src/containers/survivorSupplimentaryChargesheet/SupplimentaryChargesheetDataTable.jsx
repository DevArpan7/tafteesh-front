...
const SupplimentaryChargesheetDataTable = (props) => {
  ...
  const { chargeSheetList, onSelectRow ,selectedProduct5} = props;
  ...
  {
    return (rowData.supplimentary_chargesheet_date);
    }
  };
    ...
    <div className="dataTableFilter">
        ...
        <DataTable
          ...
          globalFilterFields={[
           ...
           "act",
           "supplimentary_chargesheet_number",
           "supplimentary_chargesheet_date"
          ]}
          header={header1}
        ...
        >
          ...
          <Column
            ...
            filter
            filterPlaceholder="Search With Section"
        ...
        <Column
            ...
            filter
            filterPlaceholder="Search With Act"
            //filterElement={dateFilterTemplate}
        />
        <Column
            header="Supplimentary Charge Sheet No."
            // dataType="date"
            filterField="supplimentary_chargesheet_number"
            style={{ minWidth: "12rem" }}
            body={SupplimentaryChargesheetNumberBodyTemplate}
            filter
            filterPlaceholder="Search With Charge Sheet"
            //filterElement={balanceFilterTemplate}
          />
        <Column
            header="Supplimentary Charge sheet date"
            dataType="date"
            filterField="supplimentary_chargesheet_date"
            showFilterMatchModes={false}
            filterMenuStyle={{ width: "10rem" }}
            style={{ minWidth: "10rem" }}
            body={chargeSheetDateBodyTemplate}
            filterPlaceholder="Search With Charge Sheet Date"
            // filter
